...
#define NUS_BASE_UUID                  {{0x48, 0xD9, 0x4E, 0x61, 0x87, 0x50, 0xCE, 0xA2, 0x1C, 0x46, 0x48, 0x83, 0x33, 0xAB, 0xD3, 0xA2}} /**< Used vendor specific UUID. */
...
extern kd_bool ble_isconnected;
#endif
