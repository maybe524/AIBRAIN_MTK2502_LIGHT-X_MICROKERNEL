...
#define IS_LEVEL_HIGH(v)		((v) & IRQ_CFG_LEVEL_HIGH)
#define IS_LEVEL_LOW(v)			((v) & IRQ_CFG_LEVEL_LOW)
#define IS_TRIGGLE_RISING(v)	((v) & IRQ_CFG_TRIGGLE_RISING)
#define IS_TRIGGLE_FALLING(v)	((v) & IRQ_CFG_TRIGGLE_FALLING)
#define IS_TRIGGLE(v)			(IS_TRIGGLE_FALLING(v) | IS_TRIGGLE_RISING(v))

#define IS_HI_ACCURACY(v)		((v) & IRQ_CFG_HI_ACCURACY)
#define IS_NOPULL(v)			((v) & IRQ_CFG_NOPULL)
#define IS_PULLDOWN(v)			((v) & IRQ_CFG_PULLDOWN)
#define IS_PULLUP(v)			((v) & IRQ_CFG_PULLUP)

#define IS_WATCHER(v)			((v) & IRQ_CFG_WATCHER)
#endif
