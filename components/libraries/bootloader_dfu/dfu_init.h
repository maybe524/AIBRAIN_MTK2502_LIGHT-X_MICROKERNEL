...
/** The device info offset can be modified to place the device info settings at a different location.
  ...
  */
/** [DFU UICR DEV offset] */
#define UICR_CUSTOMER_DEVICE_INFO_OFFSET    0x18                                             /**< Device info offset inside the customer UICR reserved area. Customers may change this value to place the device information in a user-preferred location. */
/** [DFU UICR DEV offset] */
 ...
 */
uint32_t dfu_init_postvalidate(uint8_t * p_image, uint32_t image_len, uint16_t * p_m_image_crc);
